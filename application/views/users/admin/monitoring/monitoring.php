      ...
      <div class="panel panel-flat" style="border-radius: 20px; border-top: 5px solid #007BFF;">
          <div class="panel-body">
            <fieldset class="content-group">
              <legend class="text-bold"><i class="fa-solid fa-chart-simple"></i> GRAFIK NILAI PKL</legend>
              <div id ="grafik"></div>
            </fieldset>
          </div>
      </div>
        ...
        <div class="panel panel-flat" style="border-radius: 20px; border-top: 5px solid #007BFF;">
            <div class="panel-body">
                ...
                <div class="col-md-7">
                  ...
                  <b>Tahun : <?php echo $thn; ?></b> <br>
                  <b>Jumlah Siswa : <?php echo number_format($total_siswa, 0,",","."); ?></b>
                </div>
            </div>
        </div>
        <div class="panel panel-flat" style="border-radius: 20px; border-top: 5px solid #007BFF;">
