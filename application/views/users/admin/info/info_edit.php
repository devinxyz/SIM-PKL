        ...
        <div class="panel-body">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-6" style="margin-top: 10px;">
              ...
              <input type="text" class="form-control daterange-single" id="datepicker" name="tanggal" value="<?php echo $v_info->tanggal; ?>" placeholder="dd-mm-yyyy" maxlength="10" required>
            </div>
            ...
            <div class="col-sm-12" style="margin-top: 10px;">
              ...
              <textarea class="form-control summernote" id="deskripsi" name="deskripsi" rows="11" placeholder="Deskripsi" required><?php echo $v_info->deskripsi; ?></textarea>
            </div>
            ...
            <!-- File Dokumen -->
            <div class="col-sm-12" style="margin-top: 10px;">
              <label for="file"><b>File Dokumen</b></label>
