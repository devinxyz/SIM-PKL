        ...
        <div class="panel panel-flat" style="border-radius: 20px; border-top: 5px solid #007BFF; ">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"> Edit Industri <?php echo ucwords($user->nama_industri); ?></legend>
                <?php
                echo $this->session->flashdata('msg');?>
                  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">Dokumen MOU</label>
                      <div class="col-lg-9">
                        <input type="file" name="mou" class="form-control" value="" placeholder="Mou">
