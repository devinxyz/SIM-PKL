        ...
        <div class="panel panel-flat" style="border-radius: 20px; border-top: 5px solid #007BFF;">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                <legend class="text-bold"><i class="icon-user-plus"></i> Tambah Pengguna <?php if ($sub_menu3 == 't_pemb') {echo "Pembimbing";}else{echo "Siswa";} ?></legend>
                <?php
                ...
                <?php
                  ...
                  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <input type="text" name="nis" class="form-control" value="" placeholder="NIS" maxlength="50" required>
                      </div>
                    </div>
