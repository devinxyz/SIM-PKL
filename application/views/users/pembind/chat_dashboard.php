    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h6 class="panel-title"><i class="icon-comment"></i> Pesan <b><?php echo ucwords($user->row()->nama_lengkap); ?></b> <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                ...
                <table class="table datatable-basic" width="100%">
                  ...
                  <tbody>
                      ...
                      foreach ($v_pemb->result() as $baris) {
                        // $cek_pemb = $this->db->get_where('tbl_penempatan')->row();
                        // if ($cek_pemb->kdpemb == $baris->kdpemb){
                      ?>
                        <tr>
                          <td><?php echo $no.'.'; ?></td>
                          <td><?php echo $baris->nama_lengkap; ?></td>
                          <td>
                            <a href="javascript:;" data-friend="<?= $baris->kdpemb ?>" class="btn btn-success btn-xs"><i class="icon-comment"></i></a>
                          </td>
                        </tr>
                      <?php
                      $no++;
...
<div id="wgt-container-template" style="display: none">
    <div class="msg-wgt-container">
        ...
        <div class="msg-wgt-message-form">
            <textarea name="message" placeholder="Type your message. Tekan Shift + Enter Unt newline"></textarea>
        </div>
    </div>
</div>
