  ...
  <div class="content">
    ...
    <div class="row">
      ...
      <div class="panel panel-flat" style="border-radius: 20px;">
        <div class="panel-heading" style=" border-radius: 20px; border-top: 5px solid #007BFF;">
          <h6 class="panel-title"><i class="fa-solid fa-pen-to-square"></i> Data Jurnal Harian | Siswa Bimbingan <b><?php echo ucwords($user->row()->nama_lengkap); ?></b> <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
            ...
            <tbody>
              ...
              foreach ($v_jurnal->result() as $baris) {
                ...
                if ($cek_status == 'diterima') {
                  ...
                  $kelas       = ($cek_kelas->kdkelas == '') ? '-' : $cek_kelas->nama;
                  $cek_jurusan = $this->db->get_where('tbl_jurusan', "kdjurusan='$cek_kelas->kdjurusan'")->row();
                  $jurusan     = ($cek_jurusan->kdjurusan == '') ? '-' : $cek_jurusan->nama;

                  $status_verif = $baris->status_verifikasi;
              ...
              ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="users/jurnal/d/<?php echo $baris->kdjurnal; ?>" class="btn btn-info btn-xs">
                      <i class="icon-eye"></i> 
                    </a>
                  </td>
                </tr>
