            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                <hr>
                  ...
                  <?php if ($user->status_verifikasi == null): ?>
                    <hr>
                    <form action="<?php echo site_url('users/verifikasi_jurnal'); ?>" method="post">
                      <input type="hidden" name="kdjurnal" value="<?php echo $user->kdjurnal; ?>">
                    ...
                    <div class="alert alert-info">
                      <b>Status Verifikasi:</b> <?php echo ucfirst($user->status_verifikasi); ?><br>
                      <?php if ($user->status_verifikasi == 'ditolak'): ?>
                        <b>Catatan:</b> <?php echo $user->catatan_verifikasi; ?>
                      <?php endif; ?>
                    </div>
                    <?php endif; ?>
