    ...
    <div class="row">
      ...
      <div class="panel panel-flat" style=" border-radius: 20px;">
        <div class="panel-heading" style=" border-radius: 20px; border-top: 5px solid #007BFF;">
          <h6 class="panel-title"><i class="fa-solid fa-book"></i> Data Laporan PKL | Siswa Bimbingan <b><?php echo ucwords($user->row()->nama_lengkap); ?></b> <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                  ...
                  <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <a href="users/laporan_pkl_siswa/d/<?php echo $baris->kdlaporan; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                            </td>
                          </tr>
