    ...
    <div class="row">
      ...
      <div class="panel panel-flat" style="border-radius: 20px; border-top: 5px solid #007BFF;">
        <div class="panel-heading" style="border-radius: 20px;">
          <h6 class="panel-title"><i class="fa-solid fa-star"></i> Data Nilai  | Siswa Bimbingan <b><?php echo ucwords($user->row()->nama_lengkap); ?></b> <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
        ...
        <div class="panel-body">
                ...
                ?>
                <a href="users/nilai/t" class="btn btn-primary"><i class="fa-solid fa-circle-plus"></i> Isi Nilai</a>
