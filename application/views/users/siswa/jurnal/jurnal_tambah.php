  ...
  <div class="row">
    ...
    <div class="panel panel-flat col-md-6" style="border-radius: 20px; border-top: 5px solid #007BFF;">
      <div class="panel-heading">
        <h5 class="panel-title"> Jurnal Harian</h5>
        ...
        <div class="panel-body">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-12 pull-left" style="margin-top: 10px;">
              <label for="kompotensi"><b>Bidang Kerja</b></label>
              <input type="text" class="form-control" id="kompotensi" name="kompotensi" value="" placeholder="Bidang Kerja" maxlength="50" required>
            </div>
            <div class="col-sm-12 pull-left" style="margin-top: 10px;">
              <label for="uraian"><b>Uraian</b></label>
              <textarea class="form-control" id="uraian" name="uraian" rows="4" cols="80" placeholder="Uraian Kegiatan" required></textarea>
            </div>
            <div class="col-sm-12 pull-left" style="margin-top: 10px;">
              <label for="file"><b>Foto</b></label>
              <input type="file" name="file" class="form-control" value="" placeholder="Foto" required>
              <b style="color:red;font-size:10px;">Pastikan File JPG, JPEG, PNG *Max Size: 5 MB</b>
            </div>
            <div class="col-sm-12 pull-left" style="margin-top: 10px;">
              <hr>
