    ...
    <div class="row">
      ...
      <div class="panel panel-flat" style="border-radius: 20px; border-top: 5px solid #007BFF;">
        <div class="panel-heading" style="border-radius: 20px;">
          <h6 class="panel-title"><i class="icon-star-full2"></i> Data Nilai PKL <b><?php echo ucwords($user->row()->nama_lengkap); ?></b><a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                  ...
                  <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="users/nilai_prakerin/d/<?php echo $baris->kdnilai; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                          </td>
                        </tr>
                      <?php
                      $no++;
