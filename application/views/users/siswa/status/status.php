...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="alert alert-success alert-dismissible" role="alert" style="border-radius: 20px; ">
          <i class="icon-checkmark-circle"></i> Selamat Datang di Sistem Informasi PKL SMK
        </div>
      </div>
    </div>
  <?php if ($cek_penempatan->num_rows() == 0){?>
    <div class="row">
      <div class="col-md-12">
        <div class="alert alert-danger alert-dismissible" role="alert" style="border-radius: 20px; border-top: 5px solid #007BFF;">
         
          CATATAN :
          <ol>
            <li>
              Silahkan Download Formulir Surat PKL, Edit sesuai dengan kebutuhan, lalu cetak dan ajukan ke ketua jurusan.
            </li>
            <li>
              Pastikan kembali data yang anda ajukan sudah benar dan sesuai.
            </li>
            <li>
              Anda hanya bisa mendaftar 1 kali. Pilihlah industri yang benar-benar Anda inginkan.
            </li>
            <li>
              Jika sudah memiliki surat balasan dari Instansi/Perusahaan, segera melakukan pendaftaran, Klik Daftar.
            </li>
          </ol>
          <hr>
          <a href="users/status_prakerin/t" class="btn btn-primary"><i class="icon-plus22"></i> Daftar</a>
          <a href="lampiran/formulir.DOCX" class="btn btn-success" target="_blank"><i class="icon-cloud-download"></i> Formulir Surat PKL</a>
        </div>
      </div>
    </div>
  <?php }else{?>
    <div class="row">
      ...
      if ($cek_penempatan->row()->status == 'proses') {?>
        ...
        $pembimbing_ind = $this->db->get_where('tbl_pembind', "kdind='$user->kdind'")->row()->nama_lengkap;
        if ($pembimbing_ind == '') {
            $pembimbing_ind = '-';
        }
        ...
        <div class="panel panel-flat" style="border-radius: 20px ;">

            <div class="panel-body" style="border-radius: 20px; border-top: 5px solid #007BFF;">

              <fieldset class="content-group">
                <legend class="text-bold"><i class="fa-solid fa-wrench"></i> Status PKL</legend>
